...
; 0000 0041 {
	...
	.CSEG
; 0000 0042 TWCR=(1<<TWINT)|(1<<TWEN)|(1<<TWSTO);           //stop communication
; 0000 0043 }
;
;void RTC_read()
; 0000 0046 {
; 0000 0047 TWCR=(1<<TWINT)|(1<<TWSTA)|(1<<TWEN);
; 0000 0048 while((TWCR&0x80)==0x00);
; 0000 0049 TWDR=0xD0;                                         //RTC write (slave address)
; 0000 004A TWCR=(1<<TWINT)|(1<<TWEN);
; 0000 004B while(!(TWCR&(1<<TWINT)));
; 0000 004C TWDR=0x00;                                         //RTC write (word address)
; 0000 004D TWCR=(1<<TWINT)|(1<<TWEN);
; 0000 004E while(!(TWCR&(1<<TWINT)));
; 0000 004F TWCR=(1<<TWINT)|(1<<TWSTA)|(1<<TWEN);              //start RTC  communication again
; 0000 0050 while ((TWCR&0x80)==0x00);
; 0000 0051 TWDR=0xD1;                                        // RTC command to read
; 0000 0052 TWCR=(1<<TWINT)|(1<<TWEN);
; 0000 0053 while(!(TWCR&(1<<TWINT)));
; 0000 0054 }
;
;//-------------------------------------------------------------------------------------------
;
...
; 0000 0065 DDRB=(0<<DDB7) | (0<<DDB6) | (0<<DDB5) | (0<<DDB4) | (0<<DDB3) | (0<<DDB2) | (0<<DDB1) | (0<<DDB0);
	OUT  0x17,R30
...
; 0000 006B DDRC=(1<<DDC7) | (1<<DDC6) | (1<<DDC5) | (1<<DDC4) | (1<<DDC3) | (1<<DDC2) | (1<<DDC1) | (1<<DDC0);
	LDI  R30,LOW(255)
	OUT  0x14,R30
...
; 0000 009A ASSR=0<<AS2;
	OUT  0x22,R30
; 0000 009B TCCR2=(0<<WGM20) | (0<<COM21) | (0<<COM20) | (0<<WGM21) | (0<<CS22) | (0<<CS21) | (0<<CS20);
	OUT  0x25,R30
...
; 0000 00A0 TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (0<<OCIE1A) | (0<<OCIE1B) | (0<<TOIE1) | (0<<OCIE0) | (0<<TOIE0);
	OUT  0x39,R30
; 0000 00A1 
